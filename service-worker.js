...
async function cacheFirstNavigate(request) {
  ...
  try {
    ...
    return new Response("<!doctype html><title>オフライン</title><meta charset=\"utf-8\"><body><h1>オフライン</h1><p>一度オンラインでアプリを開いてください。</p></body>", { headers: { "Content-Type": "text/html; charset=utf-8" } });
  }
}
